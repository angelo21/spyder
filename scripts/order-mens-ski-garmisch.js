...
imageChange.src = "../../images/order-description/mens/mens-ski/garmisch/garmisch.jpg";
});

garmischFront.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/mens/mens-ski/garmisch/garmisch-front.jpg";
});

garmischBack.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/mens/mens-ski/garmisch/garmisch-back.jpg";
});

garmischBackZoom.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/mens/mens-ski/garmisch/garmisch-back-zoom.jpg";
});

garmischLogo.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/mens/mens-ski/garmisch/garmisch-logo.jpg";
});
