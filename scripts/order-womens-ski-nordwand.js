...
nordwand.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/womens/womens-ski/nordwand/nordwand.jpg";
})

nordwandFront.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/womens/womens-ski/nordwand/nordwand-front.jpg";
})

nordwandBack.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/womens/womens-ski/nordwand/nordwand-back.jpg";
})

nordwandBackZoom.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/womens/womens-ski/nordwand/nordwand-back-zoom.jpg";
})

nordwandlogo.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/womens/womens-ski/nordwand/nordwand-logo.jpg";
})
