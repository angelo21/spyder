...
bernese.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/womens/womens-white-spyder/bernese/bernese.jpg";
})

berneseFront.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/womens/womens-white-spyder/bernese/bernese-front.jpg";
})

berneseBack.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/womens/womens-white-spyder/bernese/bernese-back.jpg";
})

berneseBackZoom.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/womens/womens-white-spyder/bernese/bernese-back-zoom.jpg";
})

berneseLogo.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/womens/womens-white-spyder/bernese/bernese-logo.jpg";
})
