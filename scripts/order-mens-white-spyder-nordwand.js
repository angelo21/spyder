...
nordwand.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/mens/mens-white-spyder/nordwand/nordwand.jpg";
});

nordwandFront.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/mens/mens-white-spyder/nordwand/nordwand-front.jpg";
});

nordwandBack.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/mens/mens-white-spyder/nordwand/nordwand-back.jpg";
});

nordwandBackZoom.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/mens/mens-white-spyder/nordwand/nordwand-back-zoom.jpg";
});

nordwandLogo.addEventListener("click", function() {
    imageChange.src = "../../images/order-description/mens/mens-white-spyder/nordwand/nordwand-logo.jpg";
});
